...
入口 京东 我的 全民挖现金
运行一次查看邀请码 变量你的邀请码 
export shareCode="1C24321E0F94D0F6D505755019F6D4E8AD1DAAB9A3E3F6CBAFDE81EEB7393333"
[task_local]
0 10 * * *
*/
...
let allMessage = '';
let shareCode = '1C24321E0F94D0F6D505755019F6D4E8AD1DAAB9A3E3F6CBAFDE81EEB7393333';
...
function helpme() {
    return new Promise(async (resolve) => {
                ...
                let options = {
    url: `https://api.m.jd.com/client.action`,
    body: `functionId=help_activity&body={"shareCode":"${shareCode}","name":"","imageUrl":"","activityKey":"2021"}&client=wh5&clientVersion=1.0.0&osVersion=10&uuid=4633169366661643-1313466623535643`,
headers: {
"Origin": "https://h5.m.jd.com",
"Host": "api.m.jd.com",
        "User-Agent": $.isNode() ? (process.env.JD_USER_AGENT ? process.env.JD_USER_AGENT : (require('./USER_AGENTS').USER_AGENT)) : ($.getdata('JDUA') ? $.getdata('JDUA') : "jdapp;android;10.0.4;10;4633169366661643-1313466623535643;network/wifi;model/Redmi K30 5G Speed;addressid/400720216;aid/d3a9ffa411df25e4;oaid/9b80ba01c51ab892;osVer/29;appBuild/88641;partner/xiaomi001;eufv/1;jdSupportDarkMode/0;Mozilla/5.0 (Linux; Android 10; Redmi K30 5G Speed Build/QKQ1.191222.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 MQQBrowser/6.2 TBS/045227 Mobile Safari/537.36"),
      "Cookie": "cuid=eidA752481205fs55ANBrjf5RSGX0Uia%252BH%252BuEOQDQyV%252Bzab26MHYxGQHHHl8F2puVA4fx3BPd%252BtUiET4HVXq6INuP1dRDOtxMD4Bc4o4TcmB7lWfhM5W;"+cookie,
      }
                }
...
function helpme1() {
    ...
    body: `functionId=current_activity&body={"shareCode":"1C24321E0F94D0F6D505755019F6D4E8AD1DAAB9A3E3F6CBAFDE81EEB7393333"}&client=wh5&clientVersion=1.0.0&osVersion=10&uuid=7049442d7e415232`,
headers: {
"Origin": "https://h5.m.jd.com",
"Host": "api.m.jd.com",
      "User-Agent": "jdltapp;iPhone;3.3.6;14.3;75aeceef3046d8ce11d354ff89af9517a2e4aa18;network/wifi;hasUPPay/0;pushNoticeIsOpen/0;lang/zh_CN;model/iPhone9,2;addressid/;hasOCPay/0;appBuild/1060;supportBestPay/0;pv/56.42;apprpd/;ref/JDLTSubMainPageViewController;psq/38;ads/;psn/75aeceef3046d8ce11d354ff89af9517a2e4aa18|99;jdv/0|kong|t_1001003207_1762319_6901310|jingfen|30578707801140d09fcd54e5cd83bbf7|1621510932517|1621511027;adk/;app_device/IOS;pap/JA2020_3112531|3.3.6|IOS 14.3;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1",
